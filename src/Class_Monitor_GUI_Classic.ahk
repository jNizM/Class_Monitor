...
; AHK Version ...: 1.1.22.01 x64 Unicode
; Win Version ...: Windows 7 Professional x64 SP1
; Description ...: Monitor GUI Class
; Version .......: v1.00
; Modified ......: 2015.05.25-1827
; Author(s) .....: jNizM
; ===============================================================================================================================
...
loop % DllCall("user32.dll\GetSystemMetrics", "Int", 80) - 1
{
    DllCall("kernel32.dll\Sleep", "UInt", 100)    ; Prevent empty fields since the functions takes from 0 to 90 milliseconds to return.
    num := A_Index + 1
    Gui, Font, s9 w400 q1 c000000, MS Shell Dlg 2
...
SetSettings:
    Gui, Submit, NoHide
    loop % DllCall("user32.dll\GetSystemMetrics", "Int", 80)
